...
- **Read** — 57 tools, grouped the way the app groups them:
  ...
  **R19 now starts at the DOORS, and at ALL of them.** The parity check used to walk
  ...
  red build. Today: **210 doors, 173 with a tool, 37 with a written reason** — the
  ...
  invite's audit trail and the cross-module activity feed. Of the 173, **156 are on THIS surface** and 17 are the in-app assistant's
