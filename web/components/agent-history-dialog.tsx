              ...
              {threads.map((t) => (
                <li key={t.id}>
                  <button
                    ...
                    disabled={busy}
                    className="hover:bg-muted focus-visible:ring-ring flex w-full flex-col items-start gap-0.5 rounded-xl p-2 text-left focus-visible:ring-2 focus-visible:outline-none disabled:opacity-50"
                  >
