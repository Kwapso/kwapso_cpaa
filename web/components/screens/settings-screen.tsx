...
// Settings — your Account (profile) and your Teams. A content component rendered inside
// the one deep-link shell (the shell provides AppShell chrome). Tapping a team makes it
// active and opens its detail; team-switch navigation is soft (softNavigate), no reload.
