...
export const SEED: Catalogue = {
  ...
  "Back in the diary.": { de: "Wieder im Kalender.", es: "De vuelta en la agenda.", ca: "Un altre cop al calendari."},
  ...
  "Nothing in the diary this month.": { de: "Diesen Monat steht nichts im Kalender.", es: "Nada en la agenda este mes.", ca: "Res a l'agenda aquest mes."},
