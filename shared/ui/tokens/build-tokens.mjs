...
/* ============================================================================
   ...
   tokens.css  ->  tokens.json.  Four guards FAIL the build; UNRESOLVED warns.
     ...
     node tokens/build-tokens.mjs --check    (guards only, writes nothing)
...
const doc = {
  $comment:
    "GENERATED by tokens/build-tokens.mjs from tokens.css. Do not hand-edit. " +
    "Names are the commission's (section 4); values are the kwapso design kit's.",
  generatedFrom: "tokens/tokens.css",
