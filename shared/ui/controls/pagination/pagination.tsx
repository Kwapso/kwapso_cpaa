/* ============================================================================
   ...
   HOW THE ARROWS MIRROR
   `ChevronLeft` on Previous and `ChevronRight` on Next, always — the glyph is
   never swapped for the other component in RTL. Two things do the mirroring:
   the icon sits at the LOGICAL start (or end) of a flex row, so it changes
   side with the writing direction on its own; and `rtl:-scale-x-100` turns the
   mark itself, so a chevron that points away from the reading direction in
   English still points away from it in Arabic.
