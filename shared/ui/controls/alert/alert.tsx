/* ============================================================================
   ...
   · `--warning` resolves to poppy by ruling — the palette holds no amber, so
     the warning tone IS the danger tone. See GAPS-E ALR-2, which is also
     where the kit's own contradicting `--accent` (mango) dot is recorded.
  ...
  ["mt-[0.3125rem] size-2 shrink-0 rounded-pill", "motion-step"],
  {
    variants: {
      variant: {
        ...
        /** `.kw-alert--info` — sky. */
        info: "bg-info",
        /** `.kw-alert--warning` — poppy by ruling, NOT the kit's mango. ALR-2. */
        warning: "bg-warning",
      },
    },
