            ...
            return pressable ? (
              <button
                ...
                /* The reset line, WITHOUT `[font:inherit]`: Tailwind emits
                   ...
                   step (the accordion/mode-toggle bug). The tile's type lives
          ...
          return pressable ? (
            <button
              ...
              className={cn(
                ...
                /* WITHOUT `[font:inherit]` — same reasoning as the bare tile
                   above: preflight's `button { font: inherit }` already does
                   the job, and the arbitrary property's late bundle position
                   is the accordion/mode-toggle bug. Measured identical live. */
                "cursor-pointer motion-hover-lift border-0 text-start",
