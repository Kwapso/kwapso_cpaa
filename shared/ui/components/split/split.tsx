    ...
    return (
      ...
      >
        ...
        >
          ...
          <List
            rows={rows}
            /* CH19 view 12's list is a column of SEPARATE cards — each row
               its own `--card` block at radius 24 with the drawn 4 of air
               between them, title 13, meta 11 (GAPS-KIT-DE L19-5, closed on
               the client's re-audit). `List variant="cards"` is that
               drawing; `panel` was one card with hairlines, a different
               object. */
            variant="cards"
            density="comfortable"
            label={listLabel}
