...
const tabsTriggerVariants = cva(
  "inline-flex items-center justify-center gap-2 py-3 text-sm whitespace-nowrap transition-colors hover:text-foreground disabled:pointer-events-none disabled:text-ink-disabled [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
