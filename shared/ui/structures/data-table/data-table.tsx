...
import { SortControl, type SortDirection } from "../../controls/sort-control/sort-control";
import {
  Table,
  TableBody,
  TableCaption,
...
import {
  ...
  useVirtualRows,
} from "../../controls/use-virtual-rows/use-virtual-rows";
                              ...
                              {opens ? (
                                <button
                                  ...
                                  className={cn(
                                    ...
                                    // column's medium weight survives.
                                    ...
                                    "rounded-[var(--radius)]",
                                    /* The kit's own inline-pressable-text
                                       treatment, copied off `Button
                                       variant="link"` rather than invented:
                                       ink-coloured, no underline at rest, an
                                       underline on hover. NOT mango — a mango
                                       name on every row would spend override
                                       17's one action per screen many times
                                       over, and the artifact draws the name
                                       cell as plain bold text. */
                                    "no-underline underline-offset-[0.1875rem] hover:underline",
                                    // No hover FILL of its own: the ROW
                                    // already washes on hover and two washes
                                    // on one row is two hover states.
