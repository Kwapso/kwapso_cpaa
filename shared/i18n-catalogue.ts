...
//
// HOW TO ADD ONE. Put the English exactly as it appears on screen, including
// its full stop. Then the three translations, or as many as you are sure of.
// `npm run check` fails if a user-visible string exists that is not in here
// (R28), and it fails again if an entry in here matches no string in the app.
