...
const seen = vi.hoisted(() => ({ sql: "", params: [] as unknown[], row: {} as Record<string, unknown> }))
...
import { boundedInner, countCollection, countCollectionWith, isCapped, reportedTotal } from "@shared/workers/count"
