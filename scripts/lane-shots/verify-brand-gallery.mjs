// Verification for the brand library's new gallery display
// (display: "gallery" on brandListRecipe, web/lib/screens.ts).
// KW_SESSION=<cookie value> node scripts/lane-shots/verify-brand-gallery.mjs
...
const OUT = ".lane-shots/brand-gallery"
...
for (const width of Object.keys(WIDTHS)) {
  for (const theme of ["light", "dark"]) {
    ...
    await page.goto(`${BASE}/t/${TEAM}/brand`, { waitUntil: "domcontentloaded" })
