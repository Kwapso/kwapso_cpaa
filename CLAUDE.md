...
- **No unbounded list endpoint (R14)** — every `list*`/`search*` read pages or carries a hard cap from `shared/workers/limits.ts`, said in a comment. (`bounded-lists`)
