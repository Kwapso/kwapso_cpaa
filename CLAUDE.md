...
- **Every colour resolves through a token (R32).** No Tailwind colour ramp and no
  ...
  UI-RULEBOOK N5)
- **The glossary is the dictionary the SCREENS speak (R33).** R6's second
