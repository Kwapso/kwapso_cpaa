...
Scanned 2026-08-04 · Overall **95/100 (Grade A)** · Lean, and self-checking down to the checks themselves — four scanners that could not fail now can, every numeric config value parses in one place, and a growing collection pages instead of refusing.
...
## Numbers
296 code files · 30,283 LOC · 33 docs (6,463 lines) · 63 test files (387 tests, 21.3% test-to-code) · 0 parked TODO/FIXME in source · 6.6% duplicate lines.
